...
class Source1Test {
    ...
    @Test
    void main_whenFirstZeroAndSecondNonZero_printsZeroResults() {
        String input = "0\n5\n";
    ...
    void main_whenBothNegative_printsCorrectResults() {
        ...
        assertTrue(s.contains("-7 + (-4) = -11"));
        assertTrue(s.contains("-7 - (-4) = -3"));
        assertTrue(s.contains("-7 * (-4) = 28"));
        assertTrue(s.contains("-7 / (-4) = 1"));
        assertTrue(s.contains("-7 % (-4) = -3"));
    }

    @Test
    void main_whenMaxIntValues_printsCorrectResultsWithoutOverflow() {
    ...
    @Test
    void main_whenMinIntValues_printsCorrectResultsWithoutOverflow() {
        ...
        assertTrue(s.contains("-2147483648 + (-1) = -2147483649")); // overflow
        assertTrue(s.contains("-2147483648 - (-1) = -2147483647"));
        assertTrue(s.contains("-2147483648 * (-1) = 2147483648")); // overflow
        assertTrue(s.contains("-2147483648 / (-1) = -2147483648")); // -2147483648 / -1 = 2147483648? Actually Java overflow => -2147483648
        assertTrue(s.contains("-2147483648 % (-1) = 0"));
    }
    ...
    @Test
    void main_whenFirstNonInteger_throwsInputMismatchException() {
        String input = "12.5\n3\n";
